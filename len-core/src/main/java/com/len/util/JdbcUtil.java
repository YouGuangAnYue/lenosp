...
//    String dbURL = "jdbc:mysql://localhost:3306/z_eas?useUnicode=true&characterEncoding=UTF-8&useSSL=false&autoReconnect=true&failOverReadOnly=false";
    ...
    String userPwd = "123";*/
    String dbURL="jdbc:mysql://117.79.92.68:3306/lenos?useUnicode=true&characterEncoding=UTF-8&useSSL=false";
    String userName = "lenosWriterH";
    String userPwd = "U0qM5LRiCBLm";
    try {
